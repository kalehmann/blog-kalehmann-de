...
I already had to create bootable floppy images in some of my projects .
This process has always been a hassle, especially automating it.
So I decided to write my own all-in-one solution to create FAT12 formatted
images - f12.
...
But the most import feature of all for me is creating new images with a set
files and installing a bootloader in one command, but let's start at the
beginning:
...
# Mount the image to put some files on it
...
Later I added also [GitLab CI](https://gitlab.com/kalehmann/f12/pipelines) and
...
proven approaches like the one using GNU mtools, I have shown at the beginning
of this post.

Nevertheless I really enjoyed all the evenings I spend coding f12, the whole
