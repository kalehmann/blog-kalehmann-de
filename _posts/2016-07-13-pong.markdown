...
lang:             en
last_modified_at: 2026-08-30 15:37:25 +0200
layout:           post
tags:
  - Coding
  - OsDev
...
[![Screenshot of the game Pong running on a real PC][real_hardware]][real_hardware]
...
[![Screenshot of the hello world bootloader running in qemu][qemu_hello_world]][qemu_hello_world]
...
<video controls>
  <source src="{{ "assets/2016-07-pong/gameplay.webm" | absolute_url }}" type="video/webm">
...
3. Real Mode - OSDev Wiki on <small><a id="ref-3"></a> [wiki.osdev.org](https://wiki.osdev.org/Real_Mode)</small>
  ...
  [qemu_hello_world]: {{ "assets/2016-07-pong/bootcode.png" | absolute_url }}
  [real_hardware]: {{ "assets/2016-07-pong/pong_real_pc.jpg" | absolute_url }}
