...
lang:             en
last_modified_at: 2026-08-29 10:42:35 +0200
layout:           post
tags:
  - Radio
title: >-
...
67 years ago - on October 4, 1957 - Sputnik 1, the first artificial satellite
of Earth was launched into orbit.
In celebration of this anniversary, the crew of the International Space Station
broadcast a series of 12 images using an amateur radio station in the Russian
module of the ISS.
...
The illustrations were transmitted using slow-scan television (SSTV) in the mode
PD120.
Each picture has a resolution of 640 x 496 pixels and took 126 seconds to fully
transmit followed by a break of about two minutes until the next picture in the
series.
Since the ISS has an orbital period of about 93 minutes, nearly 23 pictures are
transmitted per full orbit around Earth.
...
Due to the fact that the event ran Tuesday to Monday and many good
...
Unfortunately I did not find a way to simultaneously record and decode an
image on my phone, as modern versions of Android do not allow recording or
capturing audio in the background.

At home and over the weekend, I had more freedom to experiment and test different
methods to receive the signal.

[![Dirt cheap 3-element tape measure Yagi antenna][tape_measure_yagi]][tape_measure_yagi]

For example with a dirt cheap tape-measure Yagi-Uda antenna built from wood, tape
measure and the RTL-SDR Blog dipole kit.
The reflector and dipole each measured 1 meter in length and were spaced 50
centimeters apart.
A 94 centimeter long director was then added 15 centimeters in front of the
dipole.
...
I also made use of a V-dipole (50 centimeters per leg) both on top of an
attic window and out in the field.
The results were at least better than those from the handheld radio.

For these attempts I always recorded the signal using an SDR and my laptop so
that I could optimize gain and bandwidth while receiving and tweaking the
...
Here are the images I managed to receive:
...
event.
Further details on how to do so are listed on the [ARISS homepage][qsl_details].
